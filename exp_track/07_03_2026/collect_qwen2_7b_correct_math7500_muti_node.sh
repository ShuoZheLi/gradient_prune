#!/bin/bash
#SBATCH --job-name=collect_qwen2_7b_math7500
...
#SBATCH --time=4:00:00
#SBATCH --output=slurm-%j_collect_qwen2_7b_math7500.out
#SBATCH --error=slurm-%j_collect_qwen2_7b_math7500.err
...
# -----------------------------
RUN_NAME="${RUN_NAME:-collect_qwen2_7b_math7500}"
RUN_ID="${RUN_ID:-${RUN_NAME}_${SLURM_JOB_ID:-manual}}"

model_path="${MODEL_PATH:-/work2/09576/shuozhe/saved_model/Qwen2.5-7B-Instruct}"
dataset_path="${DATASET_PATH:-/work2/09576/shuozhe/saved_dataset/MetaMathQA-math-500/math7500.parquet}"
output_dir="${OUTPUT_DIR:-$repo_root/saved_calibration_dataset/Qwen2.5-7B-Instruct_math7500_correct}"
...
calib_parquet="${CALIB_PARQUET:-$output_dir/Qwen2.5-7B-Instruct_math7500_correct.parquet}"
