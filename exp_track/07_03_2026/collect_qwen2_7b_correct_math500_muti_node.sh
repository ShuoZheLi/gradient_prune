#!/bin/bash
#SBATCH --job-name=collect_qwen2_7b_math500
...
#SBATCH --time=4:00:00
#SBATCH --output=slurm-%j_collect_qwen2_7b_math500.out
#SBATCH --error=slurm-%j_collect_qwen2_7b_math500.err
...
# -----------------------------
RUN_NAME="${RUN_NAME:-collect_qwen2_7b_math500}"
...
output_dir="${OUTPUT_DIR:-$repo_root/saved_calibration_dataset/Qwen2.5-7B-Instruct_math500_correct}"
...
calib_parquet="${CALIB_PARQUET:-$output_dir/Qwen2.5-7B-Instruct_math500_correct.parquet}"
