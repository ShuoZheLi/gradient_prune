#!/bin/bash
#SBATCH --job-name=collect_qwen2_1d5b_math500
...
#SBATCH --time=4:00:00
#SBATCH --output=slurm-%j_collect_qwen2_1d5b_math500.out
#SBATCH --error=slurm-%j_collect_qwen2_1d5b_math500.err
...
# -----------------------------
RUN_NAME="${RUN_NAME:-collect_qwen2_1d5b_math500}"
RUN_ID="${RUN_ID:-${RUN_NAME}_${SLURM_JOB_ID:-manual}}"

model_path="${MODEL_PATH:-/work2/09576/shuozhe/saved_model/Qwen2.5-1.5B-Instruct}"
