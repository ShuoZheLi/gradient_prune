#!/bin/bash
#SBATCH --job-name=collect_qwen3_4b_math500
...
#SBATCH --time=4:00:00
#SBATCH --output=slurm-%j_collect_qwen3_4b_math500.out
#SBATCH --error=slurm-%j_collect_qwen3_4b_math500.err
...
# -----------------------------
RUN_NAME="${RUN_NAME:-collect_qwen3_4b_math500}"
...
output_dir="${OUTPUT_DIR:-$repo_root/saved_calibration_dataset/Qwen3-4B-instruct_math500_correct}"
...
calib_parquet="${CALIB_PARQUET:-$output_dir/Qwen3-4B-instruct_math500_correct.parquet}"
