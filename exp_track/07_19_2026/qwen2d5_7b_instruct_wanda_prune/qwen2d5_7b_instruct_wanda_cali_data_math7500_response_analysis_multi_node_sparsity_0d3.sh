#!/bin/bash
#SBATCH --job-name=qwen2d5_7b_resp_analysis_s0d3
...
#SBATCH --time=6:00:00
#SBATCH --output=slurm-%j_qwen2d5_7b_resp_analysis_s0d3.out
#SBATCH --error=slurm-%j_qwen2d5_7b_resp_analysis_s0d3.err
