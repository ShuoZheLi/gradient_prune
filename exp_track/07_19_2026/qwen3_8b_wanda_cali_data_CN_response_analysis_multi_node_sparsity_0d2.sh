#!/bin/bash
#SBATCH --job-name=qwen3_8b_CN_resp_analysis_s0d2
...
# Runtime config
# -----------------------------
RUN_NAME="${RUN_NAME:-qwen3_8b_wanda_cali_data_CN_response_analysis}"
...
SCORE_ROOT="${SCORE_ROOT:-/scratch/09576/shuozhe/gradient_prune/results/qwen3_8b_wanda_math7500/runs/qwen3_8b_prune_wanda_math7500_842865_20260719_012705/scores}"
