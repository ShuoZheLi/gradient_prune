#!/bin/bash
#SBATCH --job-name=qwen3_8b_tinyCN_wanda_s0d2
...
#SBATCH --time=6:00:00
#SBATCH --output=slurm-%j_qwen3_8b_CN_resp_analysis_s0d2.out
#SBATCH --error=slurm-%j_qwen3_8b_CN_resp_analysis_s0d2.err
...
# Uses WANDA score files generated from the tiny embedded Chinese calibration dataset.
# Uses WANDA scores generated with Chinese C4 text as the calibration dataset.
...
# Runtime config
# -----------------------------
RUN_NAME="${RUN_NAME:-qwen3_8b_wanda_tiny_CN_cali_scores_response_analysis}"
...
PRUNED_MODEL_ID="${PRUNED_MODEL_ID:-qwen3_8b_wanda_tiny_CN_cali_scores_s${PRUNING_SPARSITY}}"
DATASET_PATH="${DATASET_PATH:-/work2/09576/shuozhe/saved_dataset/MetaMathQA-math-500/test.parquet}"
CALIBRATION_DATA_LABEL="${CALIBRATION_DATA_LABEL:-Chinese C4 text (allenai/c4 zh) calibration dataset}"
SCORE_GENERATION_RUN_ID="${SCORE_GENERATION_RUN_ID:-qwen3_8b_prune_wanda_math7500_842865_20260719_012705}"
SCORE_ROOT="${SCORE_ROOT:-/scratch/09576/shuozhe/gradient_prune/results/qwen3_8b_wanda_math7500/runs/qwen3_8b_prune_wanda_math7500_843030_20260719_040320/scores}"
