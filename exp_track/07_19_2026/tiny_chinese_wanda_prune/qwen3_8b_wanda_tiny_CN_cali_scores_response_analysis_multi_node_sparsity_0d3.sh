#!/bin/bash
#SBATCH --job-name=qwen3_8b_tinyCN_wanda_s0d3
...
#SBATCH --time=6:00:00
#SBATCH --output=slurm-%j_qwen3_8b_CN_resp_analysis_s0d3.out
#SBATCH --error=slurm-%j_qwen3_8b_CN_resp_analysis_s0d3.err
