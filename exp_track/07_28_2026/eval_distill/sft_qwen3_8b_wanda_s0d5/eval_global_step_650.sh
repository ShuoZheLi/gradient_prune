#!/bin/bash
#SBATCH --job-name=eval_qwen3_8b_wanda_s0d5_global_step_650
...
#SBATCH --output=slurm-%j_eval_qwen3_8b_wanda_s0d5_global_step_650.out
#SBATCH --error=slurm-%j_eval_qwen3_8b_wanda_s0d5_global_step_650.err

set -euo pipefail

export CHECKPOINT_NAME="global_step_650"
export MODEL_PATH="/scratch/09576/shuozhe/verl_runs/sft_qwen3_8b_wanda_s0d5_base_5x7500_875886/train_log/global_step_650"
export DATASET_PATH="${DATASET_PATH:-/work/09576/shuozhe/saved_dataset/MetaMathQA-math-500/test.parquet}"
export RUN_NAME="${RUN_NAME:-sft_qwen3_8b_wanda_s0d5_base_global_step_650_math500_eval}"
