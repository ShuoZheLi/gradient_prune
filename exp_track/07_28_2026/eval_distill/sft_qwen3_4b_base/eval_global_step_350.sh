#!/bin/bash
#SBATCH --job-name=eval_qwen3_4b_global_step_350
...
#SBATCH --time=2:00:00
#SBATCH --output=slurm-%j_eval_qwen3_4b_global_step_350.out
#SBATCH --error=slurm-%j_eval_qwen3_4b_global_step_350.err
