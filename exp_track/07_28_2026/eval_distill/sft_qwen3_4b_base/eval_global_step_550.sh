...
export MODEL_PATH="/scratch/09576/shuozhe/verl_runs/sft_qwen3_4b_base_5x7500_874991/train_log/global_step_550"
export DATASET_PATH="${DATASET_PATH:-/work/09576/shuozhe/saved_dataset/MetaMathQA-math-500/test.parquet}"
export RUN_NAME="${RUN_NAME:-sft_qwen3_4b_base_global_step_550_math500_eval}"
