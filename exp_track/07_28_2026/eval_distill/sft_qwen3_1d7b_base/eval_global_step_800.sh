#!/bin/bash
#SBATCH --job-name=eval_qwen3_1d7b_global_step_800
...
export MODEL_PATH="/scratch/09576/shuozhe/verl_runs/sft_qwen3_1d7b_base_5x7500_874989/train_log/global_step_800"
...
export RUN_NAME="${RUN_NAME:-sft_qwen3_1d7b_base_global_step_800_math500_eval}"
