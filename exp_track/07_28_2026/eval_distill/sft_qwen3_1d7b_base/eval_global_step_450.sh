#!/bin/bash
#SBATCH --job-name=eval_qwen3_1d7b_global_step_450
...
#SBATCH --time=2:00:00
#SBATCH --output=slurm-%j_eval_qwen3_1d7b_global_step_450.out
#SBATCH --error=slurm-%j_eval_qwen3_1d7b_global_step_450.err

set -euo pipefail

export CHECKPOINT_NAME="global_step_450"
export MODEL_PATH="/scratch/09576/shuozhe/verl_runs/sft_qwen3_1d7b_base_5x7500_874989/train_log/global_step_450"
...
export RUN_NAME="${RUN_NAME:-sft_qwen3_1d7b_base_global_step_450_math500_eval}"
