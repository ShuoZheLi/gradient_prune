...
# Common evaluator for SFT Qwen3-8B WANDA s0d8 checkpoints.
...
run_name="${RUN_NAME:-sft_qwen3_8b_wanda_s0d8_${checkpoint_name}_math500_eval}"
...
results_subdir="${RESULTS_SUBDIR:-eval_distill/sft_qwen3_8b_wanda_s0d8/${checkpoint_name}}"
