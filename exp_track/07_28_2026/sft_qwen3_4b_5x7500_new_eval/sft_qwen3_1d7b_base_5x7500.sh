...
RUN_NAME="${RUN_NAME:-sft_qwen3_1d7b_base_5x7500}"
...
# -----------------------------
# Defaults target Qwen3-1.7B dense SFT on the full 5-response x 7500 math dataset.
...
generation_offline_output_dir=${generation_offline_output_dir:-null}
generation_offline_python=${generation_offline_python:-null}
generation_offline_launch_command=${generation_offline_launch_command:-null}
generation_offline_wait=${generation_offline_wait:-True}
generation_offline_keep_export=${generation_offline_keep_export:-True}
generation_offline_device=${generation_offline_device:-cuda}
generation_offline_cuda_visible_devices=${generation_offline_cuda_visible_devices:-null}
generation_offline_export_dtype=${generation_offline_export_dtype:-bfloat16}
...
echo "generation_eval_mode: $generation_eval_mode"
...
TRAINER_ARGS=(
  ...
  trainer.generation_eval.mode="$generation_eval_mode"
  ...
  trainer.generation_eval.vllm_max_model_len="$generation_vllm_max_model_len"
  ...
  trainer.generation_eval.offline_output_dir="$generation_offline_output_dir"
  trainer.generation_eval.offline_python="$generation_offline_python"
  trainer.generation_eval.offline_launch_command="'$generation_offline_launch_command'"
  trainer.generation_eval.offline_wait="$generation_offline_wait"
  trainer.generation_eval.offline_keep_export="$generation_offline_keep_export"
  trainer.generation_eval.offline_device="$generation_offline_device"
  trainer.generation_eval.offline_cuda_visible_devices="$generation_offline_cuda_visible_devices"
  trainer.generation_eval.offline_export_dtype="$generation_offline_export_dtype"
