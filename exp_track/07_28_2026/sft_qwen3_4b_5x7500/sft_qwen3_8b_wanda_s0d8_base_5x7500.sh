#!/bin/bash
#SBATCH --job-name=sft_qwen3_8b_wanda_s0d8
...
#SBATCH --output=sft_qwen3_8b_wanda_s0d8_5x7500-%j.out
#SBATCH --error=sft_qwen3_8b_wanda_s0d8_5x7500-%j.err
...
RUN_NAME="${RUN_NAME:-sft_qwen3_8b_wanda_s0d8_base_5x7500}"
