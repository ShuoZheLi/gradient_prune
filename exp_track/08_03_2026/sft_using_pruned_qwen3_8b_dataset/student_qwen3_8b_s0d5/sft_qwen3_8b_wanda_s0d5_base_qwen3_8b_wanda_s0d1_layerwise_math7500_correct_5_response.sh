#!/bin/bash
#SBATCH --job-name=sft_8b_s0d5_s0d1
...
#SBATCH --output=sft_qwen3_8b_wanda_s0d5_base_qwen3_8b_wanda_s0d1_layerwise_math7500_correct_5_response-%j.out
#SBATCH --error=sft_qwen3_8b_wanda_s0d5_base_qwen3_8b_wanda_s0d1_layerwise_math7500_correct_5_response-%j.err
...
RUN_NAME="${RUN_NAME:-sft_qwen3_8b_wanda_s0d5_base_qwen3_8b_wanda_s0d1_layerwise_math7500_correct_5_response}"
...
# -----------------------------
# Defaults target Qwen3-8B WANDA-pruned sparse SFT at sparsity 0.5 on the qwen3_8b_wanda_s0d1_layerwise_math7500_correct_5_response dataset.
