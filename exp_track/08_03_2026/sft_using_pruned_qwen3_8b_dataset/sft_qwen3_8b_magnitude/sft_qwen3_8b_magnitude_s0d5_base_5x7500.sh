#!/bin/bash
#SBATCH --job-name=sft_qwen3_8b_magnitude_s0d5
...
#SBATCH --output=sft_qwen3_8b_magnitude_s0d5_5x7500-%j.out
#SBATCH --error=sft_qwen3_8b_magnitude_s0d5_5x7500-%j.err
...
RUN_NAME="${RUN_NAME:-sft_qwen3_8b_magnitude_s0d5_base_5x7500}"
...
# -----------------------------
# Defaults target Qwen3-8B magnitude-pruned sparse SFT at sparsity 0.5 on the full 5-response x 7500 math dataset.
