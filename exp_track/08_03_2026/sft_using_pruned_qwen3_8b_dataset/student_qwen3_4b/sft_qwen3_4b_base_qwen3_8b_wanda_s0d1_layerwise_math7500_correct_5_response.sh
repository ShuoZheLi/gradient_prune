...
#SBATCH --output=sft_qwen3_4b_base_qwen3_8b_wanda_s0d1_layerwise_math7500_correct_5_response-%j.out
#SBATCH --error=sft_qwen3_4b_base_qwen3_8b_wanda_s0d1_layerwise_math7500_correct_5_response-%j.err
...
RUN_NAME="${RUN_NAME:-sft_qwen3_4b_base_qwen3_8b_wanda_s0d1_layerwise_math7500_correct_5_response}"
...
# -----------------------------
# Defaults target Qwen3-4B dense SFT on the qwen3_8b_wanda_s0d1_layerwise_math7500_correct_5_response dataset.
