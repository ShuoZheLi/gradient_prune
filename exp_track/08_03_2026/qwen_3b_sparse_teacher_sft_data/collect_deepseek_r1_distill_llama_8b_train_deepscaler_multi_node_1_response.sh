#!/bin/bash
#SBATCH --job-name=collect_dsk_r1_llama8b_deepscaler_n2
...
#SBATCH --output=slurm-%j_collect_dsk_r1_llama8b_deepscaler_n2.out
#SBATCH --error=slurm-%j_collect_dsk_r1_llama8b_deepscaler_n2.err
...
# Standalone collector for 2-response trajectories from the DeepSeek-R1-Distill-Llama-8B model
...
# -----------------------------
RUN_NAME="${RUN_NAME:-collect_deepseek_r1_distill_llama_8b_train_deepscaler_2_response}"
