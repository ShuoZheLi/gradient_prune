#!/bin/bash
#SBATCH --job-name=collect_dsk_r1_llama8b_deepscaler_n1
...
#SBATCH --time=6:00:00
#SBATCH --output=slurm-%j_collect_dsk_r1_llama8b_deepscaler_n1.out
#SBATCH --error=slurm-%j_collect_dsk_r1_llama8b_deepscaler_n1.err
...
# Standalone collector for 1-response trajectories from the DeepSeek-R1-Distill-Llama-8B model
...
# -----------------------------
RUN_NAME="${RUN_NAME:-collect_deepseek_r1_distill_llama_8b_train_deepscaler_1_response}"
...
output_dir="${OUTPUT_DIR:-$repo_root/saved_calibration_dataset/deepseek-r1-distill-llama-8b_train_deepscaler_correct_1_response}"
...
calib_parquet="${CALIB_PARQUET:-$output_dir/deepseek-r1-distill-llama-8b_train_deepscaler_correct_1_response.parquet}"
