...
export PRUNING_SPARSITY="${PRUNING_SPARSITY:-0.1}"
export SPARSITY_LABEL="${SPARSITY_LABEL:-s0d1}"
export RUN_NAME="${RUN_NAME:-collect_qwen3_8b_wanda_s0d1_${PRUNE_GRANULARITY:-layerwise}_math7500_5_response}"
