#!/bin/bash
#SBATCH --job-name=collect_qwen3_sparse_s0d5_n5
...
#SBATCH --time=4:00:00
#SBATCH --output=slurm-%j_collect_qwen3_sparse_s0d5_n5.out
#SBATCH --error=slurm-%j_collect_qwen3_sparse_s0d5_n5.err
...
SPARSITY_LABEL="${SPARSITY_LABEL:-s0d5}"
