...
# Standalone diagnostic launcher created on 2026-08-03.
# It intentionally does not call any previous exp_track shell script.
# Diagnostic defaults: layerwise/tensorwise WANDA pruning, K=1, greedy decoding.
...
# Runtime config
# -----------------------------
RUN_NAME="${RUN_NAME:-qwen3_8b_wanda_math500_layerwise_s0d5_k1_greedy}"
...
PRUNED_MODEL_ID="${PRUNED_MODEL_ID:-qwen3_8b_wanda_layerwise_s${PRUNING_SPARSITY}}"
...
RUN_ON_POLICY_ENTROPY="${RUN_ON_POLICY_ENTROPY:-0}"
RUN_FIXED_PREFIX_ENTROPY="${RUN_FIXED_PREFIX_ENTROPY:-0}"
RUN_SURFACE_DIVERSITY="${RUN_SURFACE_DIVERSITY:-1}"
RUN_SEMANTIC_JUDGE="${RUN_SEMANTIC_JUDGE:-0}"
