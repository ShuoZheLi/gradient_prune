...
# Common evaluator for Math7500 SFT student Qwen3-8B WANDA s0d5 checkpoints distilled from the Qwen3-8B WANDA s0d2 teacher.
...
run_name="${RUN_NAME:-sft_qwen3_8b_wanda_s0d5_base_qwen3_8b_wanda_s0d2_layerwise_${checkpoint_name}_math500_eval}"
...
results_subdir="${RESULTS_SUBDIR:-eval_distill/student_qwen3_8b_s0d5/s0d2/${checkpoint_name}}"
