#!/bin/bash
#SBATCH --job-name=eval_8b_s0d5_s0d2_global_step_100
...
#SBATCH --output=slurm-%j_eval_8b_s0d5_s0d2_global_step_100.out
#SBATCH --error=slurm-%j_eval_8b_s0d5_s0d2_global_step_100.err

set -euo pipefail

export CHECKPOINT_NAME="global_step_100"
export MODEL_PATH="/scratch/09576/shuozhe/verl_runs/sft_qwen3_8b_wanda_s0d5_base_qwen3_8b_wanda_s0d2_layerwise_math7500_correct_5_response_888642/train_log/global_step_100"
export DATASET_PATH="${DATASET_PATH:-/work/09576/shuozhe/saved_dataset/MetaMathQA-math-500/test.parquet}"
export RUN_NAME="${RUN_NAME:-sft_qwen3_8b_wanda_s0d5_base_qwen3_8b_wanda_s0d2_layerwise_global_step_100_math500_eval}"
