#!/bin/bash
#SBATCH --job-name=eval_8b_mag_s0d5_global_step_550
...
#SBATCH --output=slurm-%j_eval_8b_mag_s0d5_global_step_550.out
#SBATCH --error=slurm-%j_eval_8b_mag_s0d5_global_step_550.err

set -euo pipefail

export CHECKPOINT_NAME="global_step_550"
export MODEL_PATH="/scratch/09576/shuozhe/verl_runs/sft_qwen3_8b_magnitude_s0d5_base_5x7500_891259/train_log/global_step_550"
export DATASET_PATH="${DATASET_PATH:-/work/09576/shuozhe/saved_dataset/MetaMathQA-math-500/test.parquet}"
export RUN_NAME="${RUN_NAME:-sft_qwen3_8b_magnitude_s0d5_base_5x7500_global_step_550_math500_eval}"
