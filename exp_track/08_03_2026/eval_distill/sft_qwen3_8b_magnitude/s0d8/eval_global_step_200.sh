#!/bin/bash
#SBATCH --job-name=eval_8b_mag_s0d8_global_step_200
...
#SBATCH --output=slurm-%j_eval_8b_mag_s0d8_global_step_200.out
#SBATCH --error=slurm-%j_eval_8b_mag_s0d8_global_step_200.err

set -euo pipefail

export CHECKPOINT_NAME="global_step_200"
export MODEL_PATH="/scratch/09576/shuozhe/verl_runs/sft_qwen3_8b_magnitude_s0d8_base_5x7500_891260/train_log/global_step_200"
export DATASET_PATH="${DATASET_PATH:-/work/09576/shuozhe/saved_dataset/MetaMathQA-math-500/test.parquet}"
export RUN_NAME="${RUN_NAME:-sft_qwen3_8b_magnitude_s0d8_base_5x7500_global_step_200_math500_eval}"
