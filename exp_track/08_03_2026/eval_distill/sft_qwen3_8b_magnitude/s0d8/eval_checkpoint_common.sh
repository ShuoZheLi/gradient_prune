...
# Common evaluator for Math7500 SFT Qwen3-8B magnitude-pruned s0d8 checkpoints.
...
run_name="${RUN_NAME:-sft_qwen3_8b_magnitude_s0d8_base_5x7500_${checkpoint_name}_math500_eval}"
...
results_subdir="${RESULTS_SUBDIR:-eval_distill/sft_qwen3_8b_magnitude/s0d8/${checkpoint_name}}"
