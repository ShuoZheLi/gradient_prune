#!/bin/bash
#SBATCH --job-name=eval_4b_base_s0d2_global_step_400
...
#SBATCH --output=slurm-%j_eval_4b_base_s0d2_global_step_400.out
#SBATCH --error=slurm-%j_eval_4b_base_s0d2_global_step_400.err

set -euo pipefail

export CHECKPOINT_NAME="global_step_400"
export MODEL_PATH="/scratch/09576/shuozhe/verl_runs/sft_qwen3_4b_base_qwen3_8b_wanda_s0d2_layerwise_math7500_correct_5_response_888757/train_log/global_step_400"
export DATASET_PATH="${DATASET_PATH:-/work/09576/shuozhe/saved_dataset/MetaMathQA-math-500/test.parquet}"
export RUN_NAME="${RUN_NAME:-sft_qwen3_4b_base_qwen3_8b_wanda_s0d2_layerwise_global_step_400_math500_eval}"
