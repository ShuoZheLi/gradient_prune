...
# Common evaluator for Math7500 SFT Qwen3-4B base checkpoints distilled from the Qwen3-8B WANDA s0d4 teacher.
...
run_name="${RUN_NAME:-sft_qwen3_4b_base_qwen3_8b_wanda_s0d4_layerwise_${checkpoint_name}_math500_eval}"
...
results_subdir="${RESULTS_SUBDIR:-eval_distill/qwen3_4b_base/s0d4/${checkpoint_name}}"
