#!/bin/bash
#SBATCH --job-name=eval_4b_base_s0d4_global_step_250
...
#SBATCH --output=slurm-%j_eval_4b_base_s0d4_global_step_250.out
#SBATCH --error=slurm-%j_eval_4b_base_s0d4_global_step_250.err

set -euo pipefail

export CHECKPOINT_NAME="global_step_250"
export MODEL_PATH="/scratch/09576/shuozhe/verl_runs/sft_qwen3_4b_base_qwen3_8b_wanda_s0d4_layerwise_math7500_correct_5_response_888758/train_log/global_step_250"
export DATASET_PATH="${DATASET_PATH:-/work/09576/shuozhe/saved_dataset/MetaMathQA-math-500/test.parquet}"
export RUN_NAME="${RUN_NAME:-sft_qwen3_4b_base_qwen3_8b_wanda_s0d4_layerwise_global_step_250_math500_eval}"
