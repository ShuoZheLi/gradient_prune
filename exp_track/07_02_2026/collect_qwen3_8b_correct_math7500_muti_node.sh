#!/bin/bash
#SBATCH --job-name=collect_qwen3_8b_math7500
...
#SBATCH --time=4:00:00
#SBATCH --output=slurm-%j_collect_qwen3_8b_math7500.out
#SBATCH --error=slurm-%j_collect_qwen3_8b_math7500.err
...
# -----------------------------
RUN_NAME="${RUN_NAME:-collect_qwen3_8b_math7500}"
...
output_dir="${OUTPUT_DIR:-$repo_root/saved_calibration_dataset/qwen3-8b-instruct_math7500_correct}"
...
calib_parquet="${CALIB_PARQUET:-$output_dir/qwen3-8b-instruct_math7500_correct.parquet}"
