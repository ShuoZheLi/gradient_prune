...
NUM_GPUS=3
CONFIG="exp_track/06_27_2026/qwen25_1p5b_math_gblm_style_compact_stage1_seed42.yaml"
RESULT_ROOT="results/qwen25_1p5b_gblm_style_compact_stage1_seed42"

echo "=== Running compact Stage 1 GBLM/rank-fusion screen seed 42 on GPUs ${CUDA_VISIBLE_DEVICES} ==="
echo "Config: ${CONFIG}"
