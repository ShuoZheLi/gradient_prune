...
for SEED in 111 222; do
  CONFIG="exp_track/06_27_2026/qwen25_1p5b_math_gblm_style_stage2_finalists_seed${SEED}.yaml"
  RESULT_ROOT="results/qwen25_1p5b_gblm_style_stage2_finalists_seed${SEED}"
  echo "=== Running Stage 2 finalists seed ${SEED} on GPUs ${CUDA_VISIBLE_DEVICES} ==="
  echo "Config: ${CONFIG}"
