...
NUM_GPUS=4
CONFIG="exp_track/06_27_2026/qwen25_1p5b_math_gblm_style_stage2_finalists_seed222_gpu0123_util07.yaml"
RESULT_ROOT="results/qwen25_1p5b_gblm_style_stage2_finalists_seed222"

echo "=== Restarting Stage 2 finalists seed 222 on GPUs ${CUDA_VISIBLE_DEVICES}, gpu_memory_utilization=0.7 ==="
echo "Config: ${CONFIG}"
