#!/bin/bash
#SBATCH --job-name=qwen3_4b_inst_align_s0
...
#SBATCH --output=slurm-%j_qwen3_4b_inst_align_s0.out
#SBATCH --error=slurm-%j_qwen3_4b_inst_align_s0.err
...
# Runtime config
# -----------------------------
RUN_NAME="${RUN_NAME:-qwen3_4b_instruct_teacher_student_alignment_sparsity_0}"
...
MODEL_ID="${MODEL_ID:-qwen3_4b_instruct_teacher_wanda_sparsity_0}"
