#!/bin/bash
#SBATCH --job-name=qwen3_4b_align_sparsity_0d5
...
#SBATCH --output=slurm-%j_qwen3_4b_align_sparsity_0d5.out
#SBATCH --error=slurm-%j_qwen3_4b_align_sparsity_0d5.err
...
# Runtime config
# -----------------------------
RUN_NAME="${RUN_NAME:-qwen3_4b_base_teacher_student_alignment_sparsity_0d5}"
...
MODEL_ID="${MODEL_ID:-qwen3_4b_base_teacher_wanda_sparsity_0d5}"
