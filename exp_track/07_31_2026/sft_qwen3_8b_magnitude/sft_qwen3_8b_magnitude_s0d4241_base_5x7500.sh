#!/bin/bash
#SBATCH --job-name=sft_qwen3_8b_magnitude_s0d4241
...
#SBATCH --output=sft_qwen3_8b_magnitude_s0d4241_5x7500-%j.out
#SBATCH --error=sft_qwen3_8b_magnitude_s0d4241_5x7500-%j.err
...
RUN_NAME="${RUN_NAME:-sft_qwen3_8b_magnitude_s0d4241_base_5x7500}"
...
# -----------------------------
# Defaults target Qwen3-8B magnitude-pruned sparse SFT at sparsity 0.4241 on the full 5-response x 7500 math dataset.
