#!/bin/bash
#SBATCH --job-name=sft_qwen3_8b_wanda_s0d7552
...
#SBATCH --output=sft_qwen3_8b_wanda_s0d7552_5x7500-%j.out
#SBATCH --error=sft_qwen3_8b_wanda_s0d7552_5x7500-%j.err
...
RUN_NAME="${RUN_NAME:-sft_qwen3_8b_wanda_s0d7552_base_5x7500}"
...
# -----------------------------
# Defaults target Qwen3-8B WANDA-pruned sparse SFT at sparsity 0.7552 on the full 5-response x 7500 math dataset.
