...
# Common evaluator for SFT Qwen3-8B magnitude s0d4241 checkpoints.
...
run_name="${RUN_NAME:-sft_qwen3_8b_magnitude_s0d4241_${checkpoint_name}_math500_eval}"
...
results_subdir="${RESULTS_SUBDIR:-eval_distill/sft_qwen3_8b_magnitude_s0d4241/${checkpoint_name}}"
