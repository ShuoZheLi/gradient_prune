#!/bin/bash
#SBATCH --job-name=eval_qwen3_8b_magnitude_s0d7552_global_step_850
...
#SBATCH --output=slurm-%j_eval_qwen3_8b_magnitude_s0d7552_global_step_850.out
#SBATCH --error=slurm-%j_eval_qwen3_8b_magnitude_s0d7552_global_step_850.err

set -euo pipefail

export CHECKPOINT_NAME="global_step_850"
export MODEL_PATH="/scratch/09576/shuozhe/verl_runs/sft_qwen3_8b_magnitude_s0d7552_base_5x7500_879772/train_log/global_step_850"
export DATASET_PATH="${DATASET_PATH:-/work/09576/shuozhe/saved_dataset/MetaMathQA-math-500/test.parquet}"
export RUN_NAME="${RUN_NAME:-sft_qwen3_8b_magnitude_s0d7552_base_global_step_850_math500_eval}"
