...
# Common evaluator for SFT Qwen3-8B magnitude s0d7552 checkpoints.
...
run_name="${RUN_NAME:-sft_qwen3_8b_magnitude_s0d7552_${checkpoint_name}_math500_eval}"
...
results_subdir="${RESULTS_SUBDIR:-eval_distill/sft_qwen3_8b_magnitude_s0d7552/${checkpoint_name}}"
