...
#SBATCH --output=sft_qwen3_8b_ffn_wanda_s0d5_correct_5_response-%j.out
#SBATCH --error=sft_qwen3_8b_ffn_wanda_s0d5_correct_5_response-%j.err
...
RUN_NAME="${RUN_NAME:-sft_qwen3_8b_ffn_wanda_s0d5_correct_5_response}"
...
MODEL_INIT_CKPT="${MODEL_INIT_CKPT:-/scratch/09576/shuozhe/gradient_prune/results/qwen3_8b_ffn_wanda_structured_pruning_s0d5_correct_5_response/models/s0d5_correct_5_response}"
