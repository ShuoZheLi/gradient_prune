...
#SBATCH --output=sft_qwen3_8b_ffn_wanda_s0d25_correct_5_response-%j.out
#SBATCH --error=sft_qwen3_8b_ffn_wanda_s0d25_correct_5_response-%j.err
...
RUN_NAME="${RUN_NAME:-sft_qwen3_8b_ffn_wanda_s0d25_correct_5_response}"
...
MODEL_INIT_CKPT="${MODEL_INIT_CKPT:-/scratch/09576/shuozhe/gradient_prune/results/qwen3_8b_ffn_wanda_structured_pruning_s0d25_correct_5_response/models/s0d25_correct_5_response}"
TRAIN_FILE="${TRAIN_FILE:-/work/09576/shuozhe/gradient_prune/saved_calibration_dataset/qwen3_8b_wanda_s0d1_layerwise_math7500_correct_5_response/qwen3_8b_wanda_s0d1_layerwise_math7500_correct_5_response.parquet}"
...
# -----------------------------
# Defaults target the structurally FFN-pruned Qwen3-8B s0d7 model on the qwen3_8b_wanda_s0d1_layerwise_math7500_correct_5_response dataset.
