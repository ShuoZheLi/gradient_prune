#!/bin/bash
#SBATCH --job-name=qwen3_8b_ffn_s0d5_5resp
...
#SBATCH --time=3:00:00
#SBATCH --output=slurm-%j_qwen3_8b_ffn_wanda_s0d5_correct_5_response.out
#SBATCH --error=slurm-%j_qwen3_8b_ffn_wanda_s0d5_correct_5_response.err
