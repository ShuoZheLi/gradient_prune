#!/bin/bash
#SBATCH --job-name=qwen3_8b_ffn_s0d7_5resp
...
#SBATCH --time=8:00:00
#SBATCH --output=slurm-%j_qwen3_8b_ffn_wanda_s0d7_correct_5_response.out
#SBATCH --error=slurm-%j_qwen3_8b_ffn_wanda_s0d7_correct_5_response.err
