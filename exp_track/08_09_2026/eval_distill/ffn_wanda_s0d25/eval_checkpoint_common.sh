...
# Common evaluator for SFT Qwen3-8B FFN-WANDA s0d25 checkpoints.
...
run_name="${RUN_NAME:-sft_qwen3_8b_ffn_wanda_s0d25_${checkpoint_name}_math500_eval}"
...
results_subdir="${RESULTS_SUBDIR:-eval_distill/ffn_wanda_s0d25/${checkpoint_name}}"
