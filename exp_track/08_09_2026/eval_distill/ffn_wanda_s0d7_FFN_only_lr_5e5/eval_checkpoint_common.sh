...
# Common evaluator for SFT Qwen3-8B FFN-WANDA s0d7 FFN-only lr_5e5 checkpoints.
...
run_name="${RUN_NAME:-sft_qwen3_8b_ffn_wanda_s0d7_FFN_only_lr_5e5_${checkpoint_name}_math500_eval}"
...
results_subdir="${RESULTS_SUBDIR:-eval_distill/ffn_wanda_s0d7_FFN_only_lr_5e5/${checkpoint_name}}"
