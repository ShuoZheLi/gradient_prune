#!/bin/bash
#SBATCH --job-name=eval_ffn_s0d7_ffnonly_lr_5e5_global_step_1150
...
#SBATCH --output=slurm-%j_eval_ffn_s0d7_ffnonly_lr_5e5_global_step_1150.out
#SBATCH --error=slurm-%j_eval_ffn_s0d7_ffnonly_lr_5e5_global_step_1150.err

set -euo pipefail

export CHECKPOINT_NAME="global_step_1150"
export MODEL_PATH="/scratch/09576/shuozhe/verl_runs/sft_qwen3_8b_ffn_wanda_s0d7_correct_5_response_only_ffn_update_lr_5e5_898504/train_log/global_step_1150"
export DATASET_PATH="${DATASET_PATH:-/work/09576/shuozhe/saved_dataset/MetaMathQA-math-500/test.parquet}"
export RUN_NAME="${RUN_NAME:-sft_qwen3_8b_ffn_wanda_s0d7_correct_5_response_only_ffn_update_lr_5e5_global_step_1150_math500_eval}"
