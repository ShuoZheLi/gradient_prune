...
# Common evaluator for SFT Qwen3-8B FFN-WANDA s0d7 checkpoints.
...
run_name="${RUN_NAME:-sft_qwen3_8b_ffn_wanda_s0d7_${checkpoint_name}_math500_eval}"
...
results_subdir="${RESULTS_SUBDIR:-eval_distill/ffn_wanda_s0d7/${checkpoint_name}}"
