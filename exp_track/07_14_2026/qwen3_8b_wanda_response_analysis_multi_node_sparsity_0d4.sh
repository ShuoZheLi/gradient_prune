#!/bin/bash
#SBATCH --job-name=qwen3_8b_resp_analysis_sparsity_0d4
...
#SBATCH --time=6:00:00
#SBATCH --output=slurm-%j_qwen3_8b_resp_analysis_sparsity_0d4.out
#SBATCH --error=slurm-%j_qwen3_8b_resp_analysis_sparsity_0d4.err
