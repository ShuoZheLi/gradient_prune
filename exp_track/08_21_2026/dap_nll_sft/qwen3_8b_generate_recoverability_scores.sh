...
SAVE_INTERMEDIATE_STATS="${SAVE_INTERMEDIATE_STATS:-1}"
...
echo "[dap_nll_sft] RESOURCE NOTE: allow roughly 80 GiB host RAM on worker ranks, 200+ GiB on rank 0 during finalization, and 500+ GiB shared scratch."
