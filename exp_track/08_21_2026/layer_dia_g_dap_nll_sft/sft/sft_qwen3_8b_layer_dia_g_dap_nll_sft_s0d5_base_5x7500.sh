#!/bin/bash
#SBATCH --job-name=sft_qwen3_8b_layer_dia_s0d5
...
#SBATCH --output=sft_qwen3_8b_layer_dia_s0d5_5x7500-%j.out
#SBATCH --error=sft_qwen3_8b_layer_dia_s0d5_5x7500-%j.err

set -euo pipefail

export RUN_NAME="${RUN_NAME:-sft_qwen3_8b_layer_dia_g_dap_nll_sft_s0d5_base_5x7500}"
