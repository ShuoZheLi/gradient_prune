#!/bin/bash
#SBATCH --job-name=eval_layer_dia_s0d5_gs100
...
#SBATCH --output=slurm-%j_eval_layer_dia_s0d5_gs100.out
#SBATCH --error=slurm-%j_eval_layer_dia_s0d5_gs100.err

set -euo pipefail

export CHECKPOINT_NAME="global_step_100"
export MODEL_PATH="/scratch/09576/shuozhe/verl_runs/sft_qwen3_8b_layer_dia_g_dap_nll_sft_s0d5_base_5x7500_934351/train_log/global_step_100"
export DATASET_PATH="${DATASET_PATH:-/work/09576/shuozhe/saved_dataset/MetaMathQA-math-500/test.parquet}"
export RUN_NAME="${RUN_NAME:-sft_qwen3_8b_layer_dia_g_dap_nll_sft_s0d5_global_step_100_math500_eval}"
export RESULTS_SUBDIR="${RESULTS_SUBDIR:-eval_distill/layer_dia_g_dap_nll_sft/s0d5/global_step_100}"
