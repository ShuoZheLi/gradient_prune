#!/bin/bash
#SBATCH --job-name=eval_layer_dia_s45
...
#SBATCH --output=slurm-%j_eval_layer_dia_s45.out
#SBATCH --error=slurm-%j_eval_layer_dia_s45.err

set -euo pipefail

export SPARSITY_PERCENT="45"
export PRUNING_SPARSITY="0.45"
