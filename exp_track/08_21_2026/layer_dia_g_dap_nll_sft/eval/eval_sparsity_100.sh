#!/bin/bash
#SBATCH --job-name=eval_layer_dia_s100
...
#SBATCH --output=slurm-%j_eval_layer_dia_s100.out
#SBATCH --error=slurm-%j_eval_layer_dia_s100.err

set -euo pipefail

export SPARSITY_PERCENT="100"
export PRUNING_SPARSITY="1.00"
