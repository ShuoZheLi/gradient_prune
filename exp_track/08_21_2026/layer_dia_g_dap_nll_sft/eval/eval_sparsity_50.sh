#!/bin/bash
#SBATCH --job-name=eval_layer_dia_s50
...
#SBATCH --output=slurm-%j_eval_layer_dia_s50.out
#SBATCH --error=slurm-%j_eval_layer_dia_s50.err

set -euo pipefail

export SPARSITY_PERCENT="50"
export PRUNING_SPARSITY="0.50"
