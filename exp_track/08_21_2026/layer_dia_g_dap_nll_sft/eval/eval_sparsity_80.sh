#!/bin/bash
#SBATCH --job-name=eval_layer_dia_s80
...
#SBATCH --output=slurm-%j_eval_layer_dia_s80.out
#SBATCH --error=slurm-%j_eval_layer_dia_s80.err

set -euo pipefail

export SPARSITY_PERCENT="80"
export PRUNING_SPARSITY="0.80"
