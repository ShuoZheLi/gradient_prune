#!/bin/bash
#SBATCH --job-name=eval_layer_dia_s70
...
#SBATCH --output=slurm-%j_eval_layer_dia_s70.out
#SBATCH --error=slurm-%j_eval_layer_dia_s70.err

set -euo pipefail

export SPARSITY_PERCENT="70"
export PRUNING_SPARSITY="0.70"
