#!/bin/bash
#SBATCH --job-name=eval_layer_dia_s5
...
#SBATCH --output=slurm-%j_eval_layer_dia_s5.out
#SBATCH --error=slurm-%j_eval_layer_dia_s5.err

set -euo pipefail

export SPARSITY_PERCENT="5"
export PRUNING_SPARSITY="0.05"
