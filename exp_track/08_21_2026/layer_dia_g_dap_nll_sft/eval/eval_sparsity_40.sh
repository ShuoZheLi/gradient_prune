#!/bin/bash
#SBATCH --job-name=eval_layer_dia_s40
...
#SBATCH --output=slurm-%j_eval_layer_dia_s40.out
#SBATCH --error=slurm-%j_eval_layer_dia_s40.err

set -euo pipefail

export SPARSITY_PERCENT="40"
export PRUNING_SPARSITY="0.40"
