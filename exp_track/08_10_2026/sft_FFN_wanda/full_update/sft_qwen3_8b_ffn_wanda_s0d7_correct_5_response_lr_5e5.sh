#!/bin/bash
#SBATCH --job-name=sft_ffn_s0d7_lr_5e5
...
#SBATCH --output=sft_qwen3_8b_ffn_wanda_s0d7_correct_5_response_lr_5e5-%j.out
#SBATCH --error=sft_qwen3_8b_ffn_wanda_s0d7_correct_5_response_lr_5e5-%j.err
...
RUN_NAME="${RUN_NAME:-sft_qwen3_8b_ffn_wanda_s0d7_correct_5_response_lr_5e5}"
