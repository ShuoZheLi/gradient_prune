...
# Common evaluator for SFT Qwen3-8B FFN-WANDA s0d7 full-update lr 1e-5 checkpoints.
...
run_name="${RUN_NAME:-sft_qwen3_8b_ffn_wanda_s0d7_correct_5_response_lr_1e5_902622_${checkpoint_name}_math500_eval}"
...
results_subdir="${RESULTS_SUBDIR:-eval_distill/sft_qwen3_8b_ffn_wanda_s0d7_lr_1e5_902622/${checkpoint_name}}"
