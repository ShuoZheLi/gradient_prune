#!/bin/bash
#SBATCH --job-name=sft_4b_dsk_llama8b
...
RUN_NAME="${RUN_NAME:-sft_qwen3_4b_base_deepseek_r1_distill_llama_8b_5x7500}"
...
# -----------------------------
# Defaults target Qwen3-4B dense SFT on the DeepSeek-R1-Distill-Llama-8B 5-response x 7500 math dataset.
