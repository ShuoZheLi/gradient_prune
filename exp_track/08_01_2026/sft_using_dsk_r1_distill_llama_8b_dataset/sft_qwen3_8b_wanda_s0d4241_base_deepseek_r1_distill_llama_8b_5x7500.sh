#!/bin/bash
#SBATCH --job-name=sft_8b_wanda_dsk_llama8b
...
#SBATCH --output=sft_qwen3_8b_wanda_s0d4241_deepseek_r1_distill_llama_8b_5x7500-%j.out
#SBATCH --error=sft_qwen3_8b_wanda_s0d4241_deepseek_r1_distill_llama_8b_5x7500-%j.err
...
RUN_NAME="${RUN_NAME:-sft_qwen3_8b_wanda_s0d4241_base_deepseek_r1_distill_llama_8b_5x7500}"
...
TRAIN_FILE="${TRAIN_FILE:-/work/09576/shuozhe/gradient_prune/saved_calibration_dataset/deepseek-r1-distill-llama-8b_math7500_correct_5_response/deepseek-r1-distill-llama-8b_math7500_correct_5_response.parquet}"
...
# -----------------------------
# Defaults target Qwen3-8B WANDA-pruned sparse SFT at sparsity 0.4241 on the DeepSeek-R1-Distill-Llama-8B 5-response x 7500 math dataset.
