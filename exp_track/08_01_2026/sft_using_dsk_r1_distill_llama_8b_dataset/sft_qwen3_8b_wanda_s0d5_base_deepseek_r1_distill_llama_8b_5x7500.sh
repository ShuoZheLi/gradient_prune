#!/bin/bash
#SBATCH --job-name=sft_8b_wanda_s0d5_dsk
...
#SBATCH --output=sft_qwen3_8b_wanda_s0d5_deepseek_r1_distill_llama_8b_5x7500-%j.out
#SBATCH --error=sft_qwen3_8b_wanda_s0d5_deepseek_r1_distill_llama_8b_5x7500-%j.err
...
RUN_NAME="${RUN_NAME:-sft_qwen3_8b_wanda_s0d5_base_deepseek_r1_distill_llama_8b_5x7500}"
...
# -----------------------------
# Defaults target Qwen3-8B WANDA-pruned sparse SFT at sparsity 0.5 on the DeepSeek-R1-Distill-Llama-8B 5-response x 7500 math dataset.
