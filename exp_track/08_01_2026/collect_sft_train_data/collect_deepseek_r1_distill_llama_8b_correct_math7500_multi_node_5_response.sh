...
#SBATCH --time=3:00:00
#SBATCH --output=slurm-%j_collect_deepseek_r1_llama8b_math7500_n5.out
#SBATCH --error=slurm-%j_collect_deepseek_r1_llama8b_math7500_n5.err
...
# -----------------------------
RUN_NAME="${RUN_NAME:-collect_deepseek_r1_distill_llama_8b_math7500_5_response}"
RUN_ID="${RUN_ID:-${RUN_NAME}_${SLURM_JOB_ID:-manual}}"

model_path="${MODEL_PATH:-/work/09576/shuozhe/saved_model/DeepSeek-R1-Distill-Llama-8B}"
dataset_path="${DATASET_PATH:-/work2/09576/shuozhe/saved_dataset/MetaMathQA-math-500/math7500.parquet}"
output_dir="${OUTPUT_DIR:-$repo_root/saved_calibration_dataset/deepseek-r1-distill-llama-8b_math7500_correct_5_response}"
...
calib_parquet="${CALIB_PARQUET:-$output_dir/deepseek-r1-distill-llama-8b_math7500_correct_5_response.parquet}"
